...
ODriveCAN* odrives[] = {&odrv12, &odrv13, &odrv14, &odrv15, &odrv16, &odrv17};
ODriveCAN* odrives_can1[] = {&odrv12, &odrv13};
ODriveCAN* odrives_can2[] = {&odrv14, &odrv15};
ODriveCAN* odrives_can3[] = {&odrv16, &odrv17};
...
ODriveUserData* odrives_data[] = {&odrv12_user_data, &odrv13_user_data, &odrv14_user_data, &odrv15_user_data, &odrv16_user_data, &odrv17_user_data};
