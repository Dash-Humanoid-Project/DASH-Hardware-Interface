...
#define ODRV4_CAN_BUS_ID 1
#define ODRV5_CAN_BUS_ID 1
#define ODRV6_CAN_BUS_ID 2
#define ODRV7_CAN_BUS_ID 2
#define ODRV8_CAN_BUS_ID 2

#define ODRV0_CAN can1
#define ODRV1_CAN can1
#define ODRV2_CAN can2
#define ODRV3_CAN can2
#define ODRV4_CAN can2
#define ODRV5_CAN can2
#define ODRV6_CAN can3
#define ODRV7_CAN can3
#define ODRV8_CAN can3
