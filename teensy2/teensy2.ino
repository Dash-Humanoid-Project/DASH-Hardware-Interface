...
ODriveCAN odrv0(wrap_can_intf(ODRV6_CAN), ODRV6_CAN_NODE_ID);
ODriveCAN odrv1(wrap_can_intf(ODRV7_CAN), ODRV7_CAN_NODE_ID);
ODriveCAN odrv2(wrap_can_intf(ODRV8_CAN), ODRV8_CAN_NODE_ID);
ODriveCAN odrv3(wrap_can_intf(ODRV9_CAN), ODRV9_CAN_NODE_ID);
ODriveCAN odrv4(wrap_can_intf(ODRV10_CAN), ODRV10_CAN_NODE_ID);
ODriveCAN odrv5(wrap_can_intf(ODRV11_CAN), ODRV11_CAN_NODE_ID);
...
ODriveCAN* odrives_can3[] = {&odrv4, &odrv5};
...
ODriveUserData odrv0_user_data(ODRV6_CAN_BUS_ID, ODRV6_CAN_ORDER_ID, &ODRV6_CAN);
ODriveUserData odrv1_user_data(ODRV7_CAN_BUS_ID, ODRV7_CAN_ORDER_ID, &ODRV7_CAN);
ODriveUserData odrv2_user_data(ODRV8_CAN_BUS_ID, ODRV8_CAN_ORDER_ID, &ODRV8_CAN);
ODriveUserData odrv3_user_data(ODRV9_CAN_BUS_ID, ODRV9_CAN_ORDER_ID, &ODRV9_CAN);
ODriveUserData odrv4_user_data(ODRV10_CAN_BUS_ID, ODRV10_CAN_ORDER_ID, &ODRV10_CAN);
ODriveUserData odrv5_user_data(ODRV11_CAN_BUS_ID, ODRV11_CAN_ORDER_ID, &ODRV11_CAN);
